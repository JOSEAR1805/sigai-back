...
$parametros['id_indicador']=$id_indicador;
...
curl_setopt($ch, CURLOPT_URL, "http://localhost/indican/infoindicadorgra.php");
// curl_setopt($ch, CURLOPT_URL, "http://66.23.226.204/indican/infoindicadorgra.php");
