...
Archivo("Llega aqui","ListaGraficosAsociados0.txt");
// Inicio POST
if ($_SERVER['REQUEST_METHOD'] == 'GET')
{
	...
	Archivo("Id_Usuario: ".$idUsuario.", Id_Perfil: ".$idPerfil, "ListaGraficosAsociados1.txt");
	
	$Resultado=listarindicadores($idUsuario, $idPerfil);
	Archivo($Resultado, "ListaGraficosAsociados2.txt");
