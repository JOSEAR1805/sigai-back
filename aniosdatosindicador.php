...
if (!isset($json_data)) {
	$Estatus=3;
	$Mensaje="Debe incluir el valor a modificar en los parametros de entrada -> anios";	
	$json = array("Estatus"=>$Estatus, "Mensaje"=>$Mensaje, "anios"=>null);
...
if ($iduser > 0) 
{
	...
	if ($_SERVER['REQUEST_METHOD'] == 'POST')
	{
		...
		$Resultado=aniosdatosindicador($json_data);
		if($Resultado)
		{
			echo $Resultado;		
			exit();
