...
//if ($_SERVER['REQUEST_METHOD'] == 'GET')
{
	...
	Archivo("Llega aqui tmbien","verificar11.txt");
    //Param IN
    //(Id_Indicador, Año)

    if (isset($_POST['id_usuario'])) $idUser = $_POST['id_usuario']; else $idUser = '';
  	if (isset($_POST['id_perfil'])) $idPerfil = $_POST['id_perfil']; else $idPerfil= '';
/*	if (isset($_GET['id_Usuario'])) $idUser = $_GET['id_Usuario']; else $idUser = '';
	if (isset($_GET['id_Perfil'])) $idPerfil = $_GET['id_Perfil']; else $idPerfil= '';
  */      
	Archivo("Id_Indicador: ".$idUser.", Perfil: ".$idPerfil, "verificar1.txt");
